...
gcc -Og basic_cube.c -o vkuTestBasicCube ../lib/vk_mem_alloc/vk_mem_alloc_win64.o ../src/vkutils.c -lstdc++ -lglfw3 -lm -lvulkan-1
vkuTestBasicCube.exe

REM gcc -Og postprocessing_cube.c -o vkuTestPostProcessingCube ../lib/vk_mem_alloc/vk_mem_alloc_win64.o ../src/vkutils.c -lstdc++ -lglfw3 -lm -lvulkan-1
REM vkuTestPostProcessingCube.exe